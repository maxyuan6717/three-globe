...
const bindHexedPolygonsLayer = linkKapsule(
  "hexedPolygonsLayer",
...
export default Kapsule({
  ...
  stateInit: () => {
    ...
    return {
      ...
      destructableLayers: Object.values(layers).filter((l) =>
        l.hasOwnProperty("_destructor")
      ),
      pausableLayers: Object.values(layers).filter((l) =>
        l.hasOwnProperty("pauseAnimation")
      ),
    };
  },
